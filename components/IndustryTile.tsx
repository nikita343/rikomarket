...
import { industryText, type Industry } from "@/lib/industries";
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="mb-0.5 text-base font-bold text-navy">{name}</div>
        <div className="text-[13px] leading-snug text-mute">{desc}</div>
      </div>
